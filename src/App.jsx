        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          >
            <div className="flex flex-col items-center w-full">
              ...
              <p className="text-[9px] font-black uppercase tracking-[0.2em] text-white/40 mb-8">
    ...
    <AnimatePresence mode="wait">
      {!hasEntered ? (
        <div
          ...
          className="fixed inset-0 bg-black flex flex-col items-center justify-center cursor-pointer z-[10000]"
        >
